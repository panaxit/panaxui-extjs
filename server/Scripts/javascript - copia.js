...
function deleteData(table_name, id_name, id_value, obj_target, restrictions, Pxnfirm)
{
if (!obj_target) { alert('No está definido el destino'); return false; }
restrictions=(restrictions==undefined?'':' AND '+restrictions);
Pxnfirm==undefined?Pxnfirm=false:null;
...
//funcion para el NUEVO Px con IFRAMES
