/************************************************************************************************************
Modified By Uriel G�mez on May 2009
JS Calendar
...
var pathToImages = '../../../../Images/Controls/Calendar/';	// Relative to your HTML file
...
function highlightSelect()
{
	...
	if(this.className=='calendarSelectBox'){
		this.className = 'selectBoxOver';
		this.getElementsByTagName('IMG')[0].src = pathToImages + 'down_over.gif';
	}else if(this.className=='selectBoxOver'){
		this.className = 'calendarSelectBox';
...
function writeTopBar()
{
	...
	monthDiv.className = 'calendarSelectBox';
	if(Opera){
	...
	yearDiv.className = 'calendarSelectBox';
